...
SECRET_KEY = os.environ.get(
    "DJANGO_SECRET_KEY",
    "django-insecure-dev-key-change-this-in-production-use-env-variable",
)
...
)  # For production: collectstatic will put files here
...
# Commented out for local development - uses local media/ folder instead
# Uncomment and add credentials to .env for production deployment
# try:
#     import cloudinary
#     cloudinary.config(
